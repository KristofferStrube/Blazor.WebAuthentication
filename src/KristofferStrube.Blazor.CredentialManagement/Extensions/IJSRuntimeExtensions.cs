...
namespace KristofferStrube.Blazor.CredentialManagement.Extensions;
...
internal static class IJSRuntimeExtensions
{
    internal static async Task<IJSObjectReference> GetHelperAsync(this IJSRuntime jSRuntime)
    {
        return await jSRuntime.InvokeAsync<IJSObjectReference>(
            "import", "./_content/KristofferStrube.Blazor.CredentialManagement/KristofferStrube.Blazor.CredentialManagement.js");
    }
